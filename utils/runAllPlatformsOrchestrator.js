...
const { main: generateEnterpriseDashboard } = require('./generateEnterpriseDashboard');
...
async function main() {
  ...
  const dashboardFailed = failed > 0 && allResults.find(r => r.platform === 'DASHBOARD')?.status === 'failed';
