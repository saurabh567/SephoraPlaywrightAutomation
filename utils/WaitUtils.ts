...
class WaitUtils {
   ...
   */
  static async waitForCondition(conditionFn: any, timeoutMs: any, intervalMs: any, description: any) {
   ...
   */
  static async retryUntilNoError(fn: any, timeoutMs: any, intervalMs: any, description: any) {
    timeoutMs  = timeoutMs  || 30000;
    intervalMs = intervalMs || 1000;
    var deadline = Date.now() + timeoutMs;
    var lastError = null;
