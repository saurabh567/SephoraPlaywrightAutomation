 ...
 */
function resolveBinary(binaryName: any) {
 ...
 */
function buildNpxPlaywrightArgs(cliArgs: any[] = []) {
...
export { resolveBinary, resolveNode, resolveNpx, buildNpxPlaywrightArgs };
export default { resolveBinary: resolveBinary, resolveNode: resolveNode, resolveNpx: resolveNpx, buildNpxPlaywrightArgs: buildNpxPlaywrightArgs };
