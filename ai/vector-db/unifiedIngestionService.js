...
class UnifiedIngestionService {
  ...
  async ingestDocumentsToLocal(documents) {
    ...
    const embeddings = await this.embeddingService.embedMany(documents.map((d) => d.document));
...
module.exports = UnifiedIngestionService;
