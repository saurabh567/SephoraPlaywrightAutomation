...
module.exports = {
  run: async function run(input = {}) {
    ...
    // Copy actual screenshots to actualDir
      ...
      for (const baselineFile of baselineFiles) {
        ...
        if (fs.existsSync(actualPath)) {
          try {
            ...
            // Use pixelmatch if available, otherwise do basic byte comparison
            let pixelDiff = null;
            try {
              ...
              // Fallback: basic size comparison
