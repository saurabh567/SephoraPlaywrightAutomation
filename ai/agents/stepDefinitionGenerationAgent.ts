...
function hasSearchScenarios(input: any) {
  return input.toLowerCase().includes('search');
}

function hasFooterScenarios(input: any) {
  return input.toLowerCase().includes('footer');
}

function hasProductDetailsAddToBagFlow(input: any) {
...
export default StepDefinitionGenerationAgent;
