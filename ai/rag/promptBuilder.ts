function formatRetrievedContext(results: any) {
...
function buildRagPrompt({ task, input, retrievedDocuments, instructions = '' }: any) {
...
export { buildRagPrompt, formatRetrievedContext };
export default { buildRagPrompt, formatRetrievedContext };
