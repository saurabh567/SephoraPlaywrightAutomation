 ...
 */
function findExportedLauncherActivity(appPackage) {
 ...
 */
function launchAppViaAdb(appPackage, activity) {
  if (!appPackage) {
 ...
 */
function disableAutoLaunch(baseCapabilities) {
  var caps = {};
 ...
 */
function prepareAndroidAppLaunch(appPackage, baseCapabilities) {
  ...
  try { execSync('sleep 3', { timeout: 5000 }); } catch (_) {}
...
module.exports = {
  findExportedLauncherActivity: findExportedLauncherActivity,
  launchAppViaAdb: launchAppViaAdb,
  disableAutoLaunch: disableAutoLaunch,
  prepareAndroidAppLaunch: prepareAndroidAppLaunch,
  KNOWN_EXPORTED_ACTIVITIES: KNOWN_EXPORTED_ACTIVITIES,
};
