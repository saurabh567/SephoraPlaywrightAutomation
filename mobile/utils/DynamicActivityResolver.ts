...
class DynamicActivityResolver {
   ...
   */
  static _resolveViaDumpsys(appPackage: any) {
    try {
   ...
   */
  static _resolveViaResolveActivity(appPackage: any) {
    try {
      var out = DynamicActivityResolver._exec(
...
export default DynamicActivityResolver;
