...
class AppInstallationDetector {
   ...
   */
  static ensureAppAvailable(appPackage, appPath) {
    if (!appPackage) {
      return {
        available: false,
   ...
   */
  static _isPackageInstalled(appPackage) {
    try {
   ...
   */
  static verify(appPackage, appPath) {
...
module.exports = AppInstallationDetector;
