...
function appendLog(message: any) {
  ensureLogDir();
...
async function waitForHealthyStatus(timeoutMs: any) {
...
async function stopServerIfStartedByFramework(options: any = {}) {
...
export { checkStatus, startServerIfNeeded, stopServerIfStartedByFramework };
export default { checkStatus: checkStatus, startServerIfNeeded: startServerIfNeeded, stopServerIfStartedByFramework: stopServerIfStartedByFramework };
