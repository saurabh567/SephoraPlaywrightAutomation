...
const androidNativeCapabilities = require('../capabilities/androidNativeCapabilities');
const androidWebCapabilities = require('../capabilities/androidWebCapabilities');
const AppInstallationDetector = require('../utils/AppInstallationDetector');
const DynamicActivityResolver = require('../utils/DynamicActivityResolver');
const ChromeDriverManager = require('../utils/ChromeDriverManager');

// Singleton driver instance — shared across entire process
var _sharedDriver = null;
