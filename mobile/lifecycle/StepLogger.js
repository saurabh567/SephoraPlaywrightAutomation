...
class StepLogger {
   ...
   */
    ...
    console.log('  Passed:         ' + this.steps.filter(function(s) { return s.status === 'PASS'; }).length);
    console.log('  Failed:         ' + this.steps.filter(function(s) { return s.status === 'FAIL'; }).length);
    console.log('  Skipped:        ' + this.steps.filter(function(s) { return s.status === 'SKIP'; }).length);
    console.log('');
    ...
    return {
      ...
      passed: this.steps.filter(function(s) { return s.status === 'PASS'; }).length,
      failed: this.steps.filter(function(s) { return s.status === 'FAIL'; }).length
    };
  }
}
