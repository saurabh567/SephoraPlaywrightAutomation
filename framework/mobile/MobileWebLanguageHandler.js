 ...
 */
async function isLanguageSelectionPage(page) {
 ...
 */
async function isAmazonHomePage(page) {
  const currentUrl = page.url();
 ...
 */
async function selectEnglishOption(page) {
 ...
 */
async function waitForRedirectToHomePage(page) {
 ...
 */
async function handleIfNeeded(page, baseUrl) {
  if (!page || !baseUrl) {
